export default function MerchSection() {
  return (
    <section id="merch" className="h-screen w-full bg-black flex items-center justify-center relative">
      <div className="absolute inset-0" style={{ background: "linear-gradient(315deg, #7E4AB830 0%, rgba(0,0,0,0.9) 100%)" }} />
      <div className="relative z-10 max-w-6xl mx-auto px-8 text-center">
        <h2 className="text-6xl font-bold text-white mb-12 tracking-wide">MERCHANDISE</h2>
