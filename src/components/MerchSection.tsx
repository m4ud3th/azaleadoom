export default function MerchSection() {
  return (
    <section id="merch" className="min-h-screen w-full bg-black flex items-start justify-center relative overflow-hidden py-8 md:py-0">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-8 text-center min-h-[90vh] flex flex-col justify-start space-y-12 md:space-y-20" style={{ paddingTop: '120px' }}>
        <div className="min-h-[40vh] flex flex-col justify-center">
          ...
          <div className="backdrop-blur-sm rounded-lg p-4 md:p-6 border transition-all hover:border-[#7E4AB850]" style={{ backgroundColor: "#7E4AB820", borderColor: "#7E4AB830" }}>
